...
public class FlippinDashboard : MonoBehaviour {
	...
	private void CloseDashboard() {
		if (isOpen) {
			dashboard.transform.eulerAngles = new Vector3 (0.0f, startRotation.y, startRotation.z);
			isOpen = false;
            Debug.Log("Cerrado ");
        }
	}
	...
	private void OpenDashboard() {
		if (!isOpen) {
			dashboard.transform.eulerAngles = new Vector3(60.0f, startRotation.y, startRotation.z);
			isOpen = true;
            Debug.Log("Abierto");
        }
	}
